...
const Quotes = () => {
	return (
		<div className="bg-gray-100 p-10 md:px-16  ">
			<div className="my-24">
				...
				<p className="text-lg text-gray-700 text-center mx-auto md:w-2/4 font-sans">
					...
					The insights we have gained have allowed us to refine our content and
				...
				<div className="text-center  text-gray-600">Ansar Ul Haq</div>
				<div className="text-center text-gray-400">Team lead | senior Dev</div>
			</div>
		</div>
	);
};
